...
public class FileManagerTest {
    ...
    public void testFileExist(){
        ...
        int setting = FileManager.getSettingInteger("width_game", "src/test/java/configfiletest/gfx_config.txt", 500);
    ...
    public void testWrongFormat(){
        int setting = FileManager.getSettingInteger("width_game", "src/test/java/configfiletest/configWrongFormat.txt", 500);
        assertEquals(setting, 500);
    }
