...
public class PlayerShootSystem {
    ...
    public static boolean checkShoot(IInput input){
        ...
        if(input.inputAvailable() && input.isShoot() && remainingIntervalTime <=0){//Als er input aanwezig is & er is geschoten & (de timer is afgelopen of er is nog niet geschoten)
